...
DEFAULT_WELCOME_MESSAGES = [
     "{first} Your taste makes my heart race. It bites and lingers...the taste of danger.",
     "{first} , you can ride with me.",
     "Won't you be my Darling.",
     "{first} Let's kill some Klaxosaurs together.",
     "Welcome {first} Darling!",
     "{first} Will you stay with me Forever?"
]
DEFAULT_GOODBYE_MESSAGES = [
    "Peoples are temporary, Memories are forever.",
