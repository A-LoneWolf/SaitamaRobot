...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    bot.sendMessage(
        chat.id,
        f"Let me get a taste of you <b>{user_member.user.first_name or user_id}</b> After all...you are now my darling!",
...
def adminlist(update, context):
    ...
    text = "Here are the list of my Darlings in <b>{}</b>:".format(
...
*Admins only:*
 ...
 • `/cache`*:* force refresh the admins list
"""
...
ADMIN_REFRESH_HANDLER = CommandHandler(
    "cache", refresh_admin, filters=Filters.group)
